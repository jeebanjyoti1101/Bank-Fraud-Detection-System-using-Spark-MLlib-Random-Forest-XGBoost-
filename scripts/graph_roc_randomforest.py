"""
ROC Curve for Random Forest Model Only
...
try:
    ...
    # Plot ROC curve
    plt.plot(fpr, tpr, linewidth=4, label=f'Random Forest (AUC = {roc_auc:.4f})', 
             color='#2E86AB', marker='o', markevery=50, markersize=6)
    plt.plot([0, 1], [0, 1], 'k--', linewidth=2, label='Random Classifier (AUC = 0.5000)')
    
    # Styling
    plt.xlabel('False Positive Rate', fontsize=14, fontweight='bold')
    plt.ylabel('True Positive Rate', fontsize=14, fontweight='bold')
    plt.title('ROC Curve - Random Forest Model', fontsize=16, fontweight='bold', pad=20)
